...
import {ClassAttribute, ClassConstant, ClassDefinition, InterfaceDefinition} from "abaplint/build/src/abap/types";
import {Visibility} from "abaplint/build/src/abap/types";
import {Class, Package, Inheritance, Attribute, Namespace, Method} from "famix/dist/model/famix";
import {FamixRepository} from "famix/dist/famix_repository";
import {ModelMethods} from "./model_methods";
import {StructureNode} from "abaplint/build/src/abap/nodes";
import * as Structures from "abaplint/build/src/abap/structures";
import * as Statements from "abaplint/build/src/abap/statements";
import * as Expressions from "abaplint/build/src/abap/expressions";
  ...
  private analyseClassAttributes(modelFile: ModelABAPFile, famixClass: Class,
    ...
    if (attributes) {
      for (const instanceAttr of attributes.getInstance()) {
        this.createAttributeModel(modelFile, famixClass, instanceAttr);
        // todo Update abaplint

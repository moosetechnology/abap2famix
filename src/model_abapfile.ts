import {ABAPFile} from "abaplint/build/src/files";
import {Position} from "abaplint/build/src/position";
import {FamixRepository} from "famix/dist/famix_repository";
import {SourcedEntity} from "famix/dist/model/famix/sourced_entity";
import {IndexedFileAnchor} from "famix/dist/model/famix/indexed_file_anchor";
import {StructureNode} from "abaplint/build/src/abap/nodes";
import {ModelClass} from "./model_class";
import {Package} from "famix/dist/model/famix/package";
import {ModelRepository} from "./model_repository";
import {Namespace} from "famix/dist/model/famix/namespace";
